	...
	DragAndDrop.DragArea {
		...
		MouseArea {
			...
			onClicked: {
                ...
                anchors.fill: parent
                icon: appObj.appIcon
                mainText: appObj.labelText//i18n("Resize?")
                subText: appObj.appDescription == appObj.labelText ? "" : appObj.appDescription//i18n("Alt + Right Click to resize the menu.")
    }
		}
	}
